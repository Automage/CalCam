package com.automage.calcam.graphics;
...
import com.automage.calcam.graphics.GraphicOverlay.Graphic;
...
public class TextGraphic extends Graphic {
    ...
    public TextGraphic(GraphicOverlay overlay, FirebaseVisionDocumentText.Word word) {
        super(overlay);
